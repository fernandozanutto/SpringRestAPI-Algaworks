...
import com.tutorialspring.tutorial.api.model.ComentarioInput;
import com.tutorialspring.tutorial.api.model.ComentarioModel;
...
import com.tutorialspring.tutorial.domain.service.GestaoOrdemServicoService;
...
public class ComentarioController {
	...
	private List<ComentarioModel> toCollectionModel(List<Comentario> comentarios){
		return comentarios.stream()
				.map(comentario -> toModel(comentario)).collect(Collectors.toList());
	}
}
