...
import com.tutorialspring.tutorial.api.model.OrdemServicoInput;
import com.tutorialspring.tutorial.api.model.OrdemServicoModel;
...
public class OrdemServicoController {
	...
	public ResponseEntity<OrdemServicoModel> buscar(@PathVariable Long id){
		...
		if(ordem.isPresent()) {
			OrdemServicoModel model = toModel(ordem.get());
